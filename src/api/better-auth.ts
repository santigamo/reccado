...
import { createAuthMailSender, renderOtpEmail, type AuthMailSender } from "../lib/better-auth";
...
export async function createAuth(
	...
	const options: BetterAuthOptions = {
		...
		// No emailAndPassword: email-OTP is the only method, so there is no
		// password to hash, reuse or stuff anywhere in the system.
		session: {
